 ...
 * - OTEL_LOGS_ENABLED: Enable log collection (default: false - not yet installed)
...
const LOGS_ENABLED = false; // Disabled until dependencies are installed
...
// Log exporter configuration for Loki (temporarily disabled)
